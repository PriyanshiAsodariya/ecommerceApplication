  ...
  return (
    <View>
     <View style={{width:'95%',height:170,padding:15,marginTop:20,backgroundColor:'white',marginLeft:10,borderRadius:10,shadowOpacity: 1,shadowRadius:20,elevation:4,}}>
        ...
        <Text style={{fontSize:15,marginTop:8}}>Product Id: <Text  style={{fontSize:18,color:'black'}}>{TNumber}</Text></Text>
        <View style={{flexDirection:'row',marginTop:8}}>
            <Text style={{fontSize:15,}}>Quantity:<Text  style={{fontSize:18,color:'black'}}>{Quantity}</Text></Text>
            <Text style={{fontSize:15,marginTop:5,marginLeft:100}}>Total Amount:  <Text  style={{fontSize:18,color:'black',}}>{Amount}</Text></Text>
        </View>
        <View style={{flexDirection:'row'}}>
        ...
        <Text style={{color:'green',fontSize:18,marginLeft:50,marginTop:15}}>Status :<Text  style={{fontSize:18,color:'black',}}>{Status}</Text> </Text>
        </View>
      </View>
    </View>
  )
